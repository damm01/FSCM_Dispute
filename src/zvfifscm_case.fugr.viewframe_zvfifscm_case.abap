*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFIFSCM_CASE
*   generation date: 05.08.2019 at 16:23:13
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFIFSCM_CASE       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_CASE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFIFSCM_CASE_EXTRACT
TOTAL = ZVFIFSCM_CASE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_CASE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFIFSCM_CASE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_CASE_EXTRACT
TOTAL = ZVFIFSCM_CASE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFIFSCM_CASE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_CASE'
...
TOTAL = ZVFIFSCM_CASE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFIFSCM_CASE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFIFSCM_CASE-UPD_FLAG NE SPACE.
