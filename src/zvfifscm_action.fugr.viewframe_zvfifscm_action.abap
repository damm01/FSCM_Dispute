...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ACTION'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFIFSCM_ACTION_EXTRACT
TOTAL = ZVFIFSCM_ACTION_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ACTION'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFIFSCM_ACTION-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_ACTION_EXTRACT
TOTAL = ZVFIFSCM_ACTION_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFIFSCM_ACTION-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ACTION'
...
TOTAL = ZVFIFSCM_ACTION_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFIFSCM_ACTION-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFIFSCM_ACTION-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ACTION'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFIFSCM_ACTION-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_ACTION_EXTRACT
TOTAL = ZVFIFSCM_ACTION_TOTAL
