*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFIFSCM_REAS_AC
*   generation date: 28.08.2019 at 17:29:16
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFIFSCM_REAS_AC    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REAS_AC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFIFSCM_REAS_AC_EXTRACT
TOTAL = ZVFIFSCM_REAS_AC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REAS_AC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFIFSCM_REAS_AC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_REAS_AC_EXTRACT
TOTAL = ZVFIFSCM_REAS_AC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFIFSCM_REAS_AC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REAS_AC'
...
TOTAL = ZVFIFSCM_REAS_AC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFIFSCM_REAS_AC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFIFSCM_REAS_AC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REAS_AC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFIFSCM_REAS_AC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_REAS_AC_EXTRACT
TOTAL = ZVFIFSCM_REAS_AC_TOTAL
