*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFIFSCM_REASON
*   generation date: 05.08.2019 at 16:26:43
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFIFSCM_REASON     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REASON'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFIFSCM_REASON_EXTRACT
TOTAL = ZVFIFSCM_REASON_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REASON'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFIFSCM_REASON-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_REASON_EXTRACT
TOTAL = ZVFIFSCM_REASON_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFIFSCM_REASON-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REASON'
...
TOTAL = ZVFIFSCM_REASON_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFIFSCM_REASON-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFIFSCM_REASON-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_REASON'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFIFSCM_REASON-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_REASON_EXTRACT
TOTAL = ZVFIFSCM_REASON_TOTAL
