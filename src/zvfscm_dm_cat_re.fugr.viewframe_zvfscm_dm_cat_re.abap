*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFSCM_DM_CAT_RE
*   generation date: 19.09.2019 at 17:44:28
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFSCM_DM_CAT_RE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_CAT_RE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFSCM_DM_CAT_RE_EXTRACT
TOTAL = ZVFSCM_DM_CAT_RE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_CAT_RE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFSCM_DM_CAT_RE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFSCM_DM_CAT_RE_EXTRACT
TOTAL = ZVFSCM_DM_CAT_RE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFSCM_DM_CAT_RE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_CAT_RE'
...
TOTAL = ZVFSCM_DM_CAT_RE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFSCM_DM_CAT_RE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFSCM_DM_CAT_RE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_CAT_RE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFSCM_DM_CAT_RE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFSCM_DM_CAT_RE_EXTRACT
TOTAL = ZVFSCM_DM_CAT_RE_TOTAL
