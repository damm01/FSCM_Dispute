*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFSCM_DM_REA_AC
*   generation date: 19.09.2019 at 17:10:11
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFSCM_DM_REA_AC    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_REA_AC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFSCM_DM_REA_AC_EXTRACT
TOTAL = ZVFSCM_DM_REA_AC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_REA_AC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFSCM_DM_REA_AC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFSCM_DM_REA_AC_EXTRACT
TOTAL = ZVFSCM_DM_REA_AC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFSCM_DM_REA_AC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_REA_AC'
...
TOTAL = ZVFSCM_DM_REA_AC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFSCM_DM_REA_AC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFSCM_DM_REA_AC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFSCM_DM_REA_AC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFSCM_DM_REA_AC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFSCM_DM_REA_AC_EXTRACT
TOTAL = ZVFSCM_DM_REA_AC_TOTAL
