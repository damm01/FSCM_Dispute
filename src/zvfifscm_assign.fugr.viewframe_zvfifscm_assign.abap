*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFIFSCM_ASSIGN
*   generation date: 07.08.2019 at 14:18:28
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFIFSCM_ASSIGN     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ASSIGN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFIFSCM_ASSIGN_EXTRACT
TOTAL = ZVFIFSCM_ASSIGN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ASSIGN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFIFSCM_ASSIGN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_ASSIGN_EXTRACT
TOTAL = ZVFIFSCM_ASSIGN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFIFSCM_ASSIGN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ASSIGN'
...
TOTAL = ZVFIFSCM_ASSIGN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFIFSCM_ASSIGN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFIFSCM_ASSIGN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFIFSCM_ASSIGN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFIFSCM_ASSIGN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFIFSCM_ASSIGN_EXTRACT
TOTAL = ZVFIFSCM_ASSIGN_TOTAL
